jQuery(document).ready(function() {
    ...
    $.simpleWeather({
        ...
        success: function(weather) {
            var html = $("#weather").after('<div class="weather-detail"><div class="weather-city">'+weather.city+', '+weather.region+'</div><span class="temprature"><i class="icon-'+weather.code+'"></i>'+weather.temp+'&deg; <i>'+weather.units.temp+'<i></span></div>');
